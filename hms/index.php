...
<div class="Nav" id="Nav1">
  <div class="NavbarContainer">
    <img src="images\kec.png" alt="" class="NavLogo" onclick="rtohome()">
...
<div class="HeroContent">
  ...
  <p class="HeroP">Kongu Engineering College</p>
...
<div class="FooterWrap">
  <div class="FooterLinksContainer">
    <div class="FooterLinksWrapper">
        <div class="FooterLinkItems">
            ...
            <a href="" class="FooterLink">Developers</a>
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <p class="WebsiteRights">kec  © 2024</p>
      <div class="SocialIcons">
        <a href="" class="SocialIconLink"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <a href="" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a>
        <a href="" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        <a href="" class="SocialIconLink"><i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
